...
class HindsightExperienceReplayWrapper(object):
    ...
    def __init__(self, replay_buffer, n_sampled_goal, goal_selection_strategy, wrapped_env):
        ...
        print("The her observation space of the HERWrapper is ")
        print(self.env.her_observation_space)
        print("The DQN observation space of the HERWrapper is")
        print(self.env.dqn_observation_space)
