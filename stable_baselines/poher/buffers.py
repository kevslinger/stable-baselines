...
class ReplayBuffer(object):
    ...
    # THIS IS IT BABY. THIS IS WHERE ALL THE MAGIC IS ABOUT TO HAPPEN
    def _encode_sample(self, idxes: Union[List[int], np.ndarray], observation_space: int, env: Optional[VecNormalize] = None):
        ...
        for i in idxes:
            ...
            # IS IT MAGICK
            # OR AM I A WIZARD
            obs_t = obs_t[:observation_space]
            obs_tp1 = obs_tp1[:observation_space]
    ...
    def sample(self, batch_size: int, observation_space: int, env: Optional[VecNormalize] = None, **_kwargs):
        """
        ...
        return self._encode_sample(idxes, observation_space, env=env)
