...
from stable_baselines.deepq_lstm.base_class import OffPolicyRLModel
from stable_baselines.common.vec_env import VecEnv
from stable_baselines.common.schedules import LinearSchedule
from stable_baselines.common.buffers import ReplayBuffer, PrioritizedReplayBuffer
from stable_baselines.deepq_lstm.build_graph import build_train
from stable_baselines.deepq_lstm.policies import DRQNPolicy
...
class DRQN(OffPolicyRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=5e-4, buffer_size=50000, exploration_fraction=0.1,
        ...
        super(DRQN, self).__init__(policy=policy, env=env, replay_buffer=None, verbose=verbose, policy_base=DRQNPolicy,
    ...
    def setup_model(self):
        ...
        with SetVerbosity(self.verbose):
            ...
            assert issubclass(test_policy, DRQNPolicy), "Error: the input policy for the DQN model must be " \
